...
- Name: complete-user-flow.spec.ts >> Complete User Journey - All Roles >> Login & Dashboard Access >> login as ARTIST and access dashboard
- Location: tests/e2e/complete-user-flow.spec.ts:71:11
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - textbox "Email" [ref=e23]: artist1777828685677@melodypitch.test
      - generic [ref=e24]:
