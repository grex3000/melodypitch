...
- Name: comprehensive.spec.ts >> MelodyPitch Comprehensive Flow >> Landing Page >> should display landing page correctly
- Location: tests/e2e/comprehensive.spec.ts:12:9
...
Locator: locator('h1')
Expected substring: "Connect Songwriters"
Received string:    "Where great songs meet their audience"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    9 × locator resolved to <h1 class="jsx-c3a2862e41502fa0 type-h1 mb-6 text-fg-1 leading-tight">…</h1>
      - unexpected value "Where great songs meet their audience"
