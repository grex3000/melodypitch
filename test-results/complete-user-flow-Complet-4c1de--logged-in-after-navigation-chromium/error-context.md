...
- Name: complete-user-flow.spec.ts >> Complete User Journey - All Roles >> User Session Management >> user remains logged in after navigation
- Location: tests/e2e/complete-user-flow.spec.ts:151:9
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - textbox "Email" [ref=e23]: songwriter1777828697115@melodypitch.test
      - generic [ref=e24]:
