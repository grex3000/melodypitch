...
- Name: complete-user-flow.spec.ts >> Complete User Journey - All Roles >> Role-Specific Dashboard Content >> SONGWRITER dashboard shows expected content
- Location: tests/e2e/complete-user-flow.spec.ts:117:9
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - textbox "Email" [ref=e23]: songwriter1777828694139@melodypitch.test
      - generic [ref=e24]:
