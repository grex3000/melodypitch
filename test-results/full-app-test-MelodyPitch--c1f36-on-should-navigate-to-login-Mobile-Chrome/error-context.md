...
- Name: full-app-test.spec.ts >> MelodyPitch Full Application Test Suite >> Landing Page >> navbar sign in button should navigate to login
- Location: tests/e2e/full-app-test.spec.ts:74:9
...
Call log:
  - waiting for getByRole('link', { name: /Sign in/i }).first()
    - locator resolved to <a href="/login">Sign in</a>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <nav class="sticky top-0 z-50 bg-bg-base/80 backdrop-blur-xl border-b border-border-subtle">…</nav> intercepts pointer events
