...
Locator:  locator('span:has-text("MelodyPitch")').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('span:has-text("MelodyPitch")').first()
    9 × locator resolved to <span class="hidden sm:inline text-lg font-semibold text-fg-1">MelodyPitch</span>
