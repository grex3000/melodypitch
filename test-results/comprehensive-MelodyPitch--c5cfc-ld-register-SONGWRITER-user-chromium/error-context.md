...
- Name: comprehensive.spec.ts >> MelodyPitch Comprehensive Flow >> Registration Flow >> should register SONGWRITER user
- Location: tests/e2e/comprehensive.spec.ts:39:11
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - textbox "Full name" [ref=e23]: Maren Solberg
      - generic [ref=e24]:
        - generic [ref=e25]: Email
        - textbox "Email" [ref=e26]: writer1777828758598@melodypitch.test
      - generic [ref=e27]:
