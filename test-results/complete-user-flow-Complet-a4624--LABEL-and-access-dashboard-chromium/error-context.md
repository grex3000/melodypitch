...
- Name: complete-user-flow.spec.ts >> Complete User Journey - All Roles >> Login & Dashboard Access >> login as LABEL and access dashboard
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - textbox "Email" [ref=e23]: label1777828672266@melodypitch.test
      - generic [ref=e24]:
