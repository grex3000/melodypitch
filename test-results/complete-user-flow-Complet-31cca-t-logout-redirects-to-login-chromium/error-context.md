...
- Name: complete-user-flow.spec.ts >> Complete User Journey - All Roles >> User Session Management >> logout redirects to login
- Location: tests/e2e/complete-user-flow.spec.ts:178:9
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - textbox "Email" [ref=e23]: label1777828723178@melodypitch.test
      - generic [ref=e24]:
