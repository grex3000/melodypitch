...
- Name: comprehensive.spec.ts >> MelodyPitch Comprehensive Flow >> Landing Page >> should be mobile responsive
- Location: tests/e2e/comprehensive.spec.ts:27:9
...
Locator: getByRole('link', { name: /Start Free/i })
Expected: visible
Timeout: 5000ms
