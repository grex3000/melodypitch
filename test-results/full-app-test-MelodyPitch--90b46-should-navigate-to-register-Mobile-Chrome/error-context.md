...
- Name: full-app-test.spec.ts >> MelodyPitch Full Application Test Suite >> Landing Page >> navbar get started button should navigate to register
- Location: tests/e2e/full-app-test.spec.ts:83:9
...
Call log:
  - waiting for getByRole('link', { name: /Get started/i }).first()
    - locator resolved to <a href="/register">Get started</a>
